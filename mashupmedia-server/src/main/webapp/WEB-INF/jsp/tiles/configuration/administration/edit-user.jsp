    ...
    $(document).ready(
                    function() {
                        ...
                        $("div.ui-content form").on("click", "#button-cancel", function() {
                            window.location = "<c:url value="/configuration/administration/list-users" />";
                        });
                        ...
                        $("#editUserPage").submit(
                                        function(event) {
                                            ...
                                            submitAjaxForm($(this), "<spring:message code ="configuration.administration.list-users.title" />",
                                                            "<c:url value="/configuration/administration/list-users" />");
                                        });
...
<c:url var="actionUrl"
	value="/configuration/administration/submit-user" />

<form:form modelAttribute="editUserPage" action="${actionUrl}"
	autocomplete="false">
