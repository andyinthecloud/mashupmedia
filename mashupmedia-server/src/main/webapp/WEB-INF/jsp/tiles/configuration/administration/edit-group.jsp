                        ...
                        $("#editGroupPage").submit(
                                        function(event) {
                                            ...
                                            submitAjaxForm($(this), "<spring:message code="configuration.administration.list-groups.title" />",
                                                            "<c:url value="/configuration/administration/list-groups" />");
                                        });
...
<c:url var="actionUrl"
	value="/configuration/administration/submit-group" />
<form:form modelAttribute="editGroupPage" action="${actionUrl}">
