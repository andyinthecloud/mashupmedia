...
<script type="text/javascript">
	$(document)
			.ready(
					function() {
						...
						$("div.dynamic-content").off("click",
								"#remote a.arrow-show-hide");
	...
	function displayRemoteArtistInformation(data) {
		...
		if (data.remoteImages.length > 0) {
			...
			introducton = "<a class=\"swipebox artist-profile\" href=\"" + mashupMedia.contextUrl + "\\" + firstArtistImage.imageUrl + "\"><img alt=\"image\" src=\"" + mashupMedia.contextUrl + "\\" + firstArtistImage.thumbUrl + "\"></a>";
		}
				...
				.each(
						...
						function(index, remoteImage) {
							if (index > 0) {
								$("#remote ul.images")
										.append(
												"<li class=\"box\"><a class=\"swipebox\" href=\"" + mashupMedia.contextUrl + "\\" + remoteImage.imageUrl + "\"><img alt=\"image\" src=\"" + mashupMedia.contextUrl + "\\" + remoteImage.thumbUrl + "\"></a></li>");
							}
						});
