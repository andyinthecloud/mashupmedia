...
<script type="text/javascript">
    $(document).ready(function() {
         ...
         $("div.breadcrumbs span:last-child").editable("<c:url value="/restful/media/save-media-name" />", {
        ...
        $("#re-encode").click(function() {
            $.post("<c:url value="/restful/encode/video" />", {
...
<video controls id="video-player">
	<source
		src="<c:url value="/streaming/media/${videoPage.video.id}/${mediaEncoding.mediaContentType.jPlayerContentType}" />"
