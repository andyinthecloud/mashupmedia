...
<c:url var="formUrl" value="/configuration/edit-remote-library"/>
<form:form modelAttribute="editRemoteLibraryPage" action="${formUrl}">
	...
	<div class="button-panel">
		...
		<c:if test="${editRemoteLibraryPage.libraryId > 0}">
			<a class="button" href="<c:url value="/configuration/delete-remote-library?libraryId=${editRemoteLibraryPage.libraryId}" />"><spring:message code="action.delete" /></a>
		</c:if>
	</div>
</form:form>
