...
<script type="text/javascript">
	...
	$("#location div.check-location a").click(function() {
	    var locationType = $("#location input[name='locationType']:checked").val();
...
<form:form commandName="musicLibraryPage">
	...
	<fieldset id="location" style="">
		...
		<div class="ftp">
			<label class="new-line" for="ftpLocation-host"><spring:message code="musiclibrary.location.host" /></label>
			<form:input path="ftpLocation.host" id="ftpLocation-host" />
			<br /> <label class="new-line" for="ftpLocation-port"><spring:message code="musiclibrary.location.port" /></label>
			<form:input path="ftpLocation.port" id="ftpLocation-port" />
			<br /> <label class="new-line" for="ftpLocation-path"><spring:message code="musiclibrary.location.path" /></label>
			<form:input path="ftpLocation.path" id="ftpLocation-path" />
			<br /> <label class="new-line" for="ftpLocation-username"><spring:message code="musiclibrary.location.username" /></label>
			<form:input path="ftpLocation.username" id="ftpLocation-username" />
			<br /> <label class="new-line" for="ftpLocation-password"><spring:message code="musiclibrary.location.password" /></label>
