...
<form:form commandName="musicLibraryPage">
	...
	<label for="musicLibrary-name"><spring:message
			code="musiclibrary.name" /></label>
	...
	<label for="musicLibrary-enabled"><spring:message
			code="musiclibrary.enabled" /></label>
	<br />
	...
	<fieldset id="location">
		...
		<div class="folder">
			...
			<form:input path="musicLibrary.location.path"
				id="folderLocation-path" />
		</div>
		...
		<div class="check-location">
			<a class="button" href="javascript:void(0);"><spring:message
					code="path.check" /></a> <span class="message horizontal-gap"></span>
		</div>
	</fieldset>
	...
	<form:checkboxes path="musicLibrary.groups" items="${groups}"
	...
	<input type="checkbox" id="remote-share" value="1" />
	<label for="remote-share"><spring:message
			code="library.remote.enable" /></label>
	<br />
	<fieldset id="remote-share-panel">
		...
		<div>
			<a class="button" href="javascript:;"><spring:message
