...
<div class="information">
	...
	<div class="images">
		<c:forEach items="${artistPage.remoteMediaMeta.remoteImages}"
			var="remoteImage">
			<a class="fancybox" rel="artist-images" href="${remoteImage.imageUrl}"><img src="${remoteImage.thumbUrl}" /></a>
		</c:forEach>
	</div>
...
<ul id="albums" class="items">
	<c:forEach items="${artistPage.artist.albums}" var="album">
		<li id="album-id-${album.id}" class="item"><a class="album-cover"
			href="javascript:;" rel="address:/address-load-album-${album.id}">
				<img
			...
			<ul class="control-menu">
				<li class="first play-album"><a href="javascript:;"><spring:message
							code="action.play-all" /></a></li>
				<li class="append-album"><a href="javascript:;"><spring:message
							code="action.add-all" /></a></li>
			</ul></li>
	</c:forEach>
</ul>
